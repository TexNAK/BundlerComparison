...
\begin{document}
	...
	\chapter{Durchführung}
		\section{Ausgangslage}
			...
			% TODO Re-export all graphs for a unified axis scaling
			% TODO Cite smth that defines what User and System time are
			% TODO Note that all following graphs share the same axis types
        ...
        \section{Nicht destruktive Anpassungen}
        	...
        	\subsection{Optimierung der Minifikation}
	        	% TODO Reference https://github.com/mishoo/UglifyJS2#uglify-fast-minify-mode as a source
	...
	\chapter{Auswertung}
		...
		\section{Beeinflussbarkeit der Build Dauer}
			To be done. Beantwortung der Forschungsfrage \label{question2} % TODO Write this argument
